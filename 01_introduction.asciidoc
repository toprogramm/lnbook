...
Теоретико-игровые протоколы честности:: Эта последняя категория возникает из сочетания Интернета и криптографии и является предметом данного раздела. Давайте посмотрим, как работает этот способ и в чем его преимущества и недостатки.
